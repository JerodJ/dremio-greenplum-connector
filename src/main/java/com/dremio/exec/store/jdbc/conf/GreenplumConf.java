...
@SourceType(value = "GreenplumARP", label = "Greenplum",uiConfig = "greenplum-layout.json")
public class GreenplumConf extends AbstractArpConf<GreenplumConf> {
  private static final String ARP_FILENAME = "arp/implementation/greenplum-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.greenplum.GreenplumDriver";
